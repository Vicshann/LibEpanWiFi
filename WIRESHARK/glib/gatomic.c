...
(g_atomic_int_inc) (volatile gint *atomic)
{
  InterlockedIncrement ((unsigned*)atomic);
}

gboolean
(g_atomic_int_dec_and_test) (volatile gint *atomic)
{
  return InterlockedDecrement ((unsigned*)atomic) == 0;
}
...
(g_atomic_int_compare_and_exchange) (volatile gint *atomic,
                                     ...
                                     gint           newval)
{
  return InterlockedCompareExchange ((unsigned*)atomic, newval, oldval) == oldval;
}
...
(g_atomic_int_add) (volatile gint *atomic,
                    gint           val)
{
  return InterlockedExchangeAdd ((unsigned*)atomic, val);
}
...
(g_atomic_pointer_get) (const volatile void *atomic)
{
  const volatile gpointer *ptr = (volatile gpointer *)atomic;
...
{
#if GLIB_SIZEOF_VOID_P == 8
  return InterlockedAnd64 ((volatile LONG64*)atomic, val);
#else
  return InterlockedAnd ((volatile guint*)atomic, val);
#endif
}
...
{
#if GLIB_SIZEOF_VOID_P == 8
  return InterlockedOr64 ((volatile LONG64*)atomic, val);
#else
  return InterlockedOr ((volatile guint*)atomic, val);
#endif
}
...
{
#if GLIB_SIZEOF_VOID_P == 8
  return InterlockedXor64 ((volatile LONG64*)atomic, val);
#else
  return InterlockedXor ((volatile guint*)atomic, val);
#endif
}
#else
