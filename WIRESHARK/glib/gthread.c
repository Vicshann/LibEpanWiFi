...
{
  volatile gsize *value_location = (gsize *)location;
...
{
  GRealThread* thread = (GRealThread*)data;
...
////  thread->retval = thread->thread.func (thread->thread.data);  // Vicshann
...
g_thread_self (void)
{
  GRealThread* thread = (GRealThread*)g_private_get (&g_thread_specific_private);
