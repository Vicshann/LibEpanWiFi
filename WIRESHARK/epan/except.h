...
struct except_t{
    ...
    except_t &except_t::operator =(const except_t & val)
     {
      except_id.except_code  = val.except_id.except_code; 
      except_id.except_group = val.except_id.except_group;
      except_message = val.except_message;
      except_dyndata = val.except_dyndata;
      return *this;
     }      
} ;
